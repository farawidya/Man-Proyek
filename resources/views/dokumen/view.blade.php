            ...
            <tr>
                ...
                <td>
                    <a href="" class="btn btn-sm btn-secondary modal-title" id="exampleModalLabel"
                        data-bs-toggle="modal" data-bs-target="#show"><i class="fas fa-eye"></i></a>
                    <a href="" class="btn btn-sm btn-warning modal-title" id="exampleModalLabel" data-bs-toggle="modal"
                        data-bs-target="#edit"><i class="fas fa-pen"></i></a>
                                            ...
                                            <div class="col-sm-12">
                                                <select name="status_project" id="status_project" class="form-control required" data-width="100%">
                                                    ...
                                                    @foreach ($status_project as $status_project)
                                                        <option value="{{ $status_project->id }}">{{ $status_project->status_project }}
                    </option>
                    @endforeach
                    </select>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <div class="custom-file">
                    <input type="file" class="custom-file-input" id="inputGroupFile01">
                    <label class="custom-file-label" type="file" name="dokumen" id="formFile"
                        value="{{ old('dokumen') }}"/ disabled readonly>Choose file</label>
                </div>
            </div>
        </div>
        <div class="modal-footer">
